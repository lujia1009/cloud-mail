const en = {
  ...
  syncDeleteDesc:
    "Permanently delete emails and email addresses instead of marking them as deleted.",
  multipleEmail: "Multiple Email Address",
  multipleEmailDesc:
    "Enable this feature to allow users to add multiple addresses.",
  ...
  autoCleanDesc:
    "Automatically delete emails older than the configured days. 0 means disabled.",
  ...
  codeRecognitionRulesDesc:
    "Only recognize emails containing the following info. Empty means all.",
  oss: "Object Storage",
  osDomain: "Domain",
  ...
  otherEmailDesc:
    "Emails can be forwarded to an external address, but must be verified via Cloudflare.",
